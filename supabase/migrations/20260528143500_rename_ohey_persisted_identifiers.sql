-- Rename persisted pre-release Nomo identifiers to Ohey.
-- This keeps already-created dev/prod projects aligned with the Ohey app code.
...
set avatar_url = replace(avatar_url, 'nomo_avatar:', 'ohey_avatar:')
