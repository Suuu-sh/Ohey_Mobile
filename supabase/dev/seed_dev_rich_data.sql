...
with seed_password(value) as (
  ...
  values
    ('00000000-0000-4000-8000-000000000101'::uuid, 'dev-yuta@tomo.app',   (select value from seed_password), 'ユウタ', 'dev_yuta',   'avatar', 'tomo_avatar:v1:0:1:2:0:0:3', true),
    ('00000000-0000-4000-8000-000000000102'::uuid, 'dev-ken@tomo.app',    (select value from seed_password), 'ケン',   'dev_ken',    'avatar', 'tomo_avatar:v1:5:2:5:2:1:0', false),
    ('00000000-0000-4000-8000-000000000103'::uuid, 'dev-ryo@tomo.app',    (select value from seed_password), 'リョウ', 'dev_ryo',    'avatar', 'tomo_avatar:v1:2:6:0:3:0:1', false),
    ('00000000-0000-4000-8000-000000000104'::uuid, 'dev-haru@tomo.app',   (select value from seed_password), 'ハル',   'dev_haru',   'avatar', 'tomo_avatar:v1:1:4:3:1:2:3', false),
    ('00000000-0000-4000-8000-000000000105'::uuid, 'dev-takumi@tomo.app', (select value from seed_password), 'タクミ', 'dev_takumi', 'avatar', 'tomo_avatar:v1:3:5:6:0:1:0', false),
    ('00000000-0000-4000-8000-000000000106'::uuid, 'dev-mika@tomo.app',   (select value from seed_password), 'ミカ',   'dev_mika',   'avatar', 'tomo_avatar:v1:4:3:1:4:2:2', false),
    ('00000000-0000-4000-8000-000000000107'::uuid, 'dev-ren@tomo.app',    (select value from seed_password), 'レン',   'dev_ren',    'avatar', 'tomo_avatar:v1:6:0:4:5:3:1', false),
    ('00000000-0000-4000-8000-000000000108'::uuid, 'dev-saki@tomo.app',   (select value from seed_password), 'サキ',   'dev_saki',   'avatar', 'tomo_avatar:v1:7:7:3:6:4:0', false),
    ('00000000-0000-4000-8000-000000000109'::uuid, 'dev-ana@tomo.app',    (select value from seed_password), 'Ana',    'dev_ana',    'avatar', 'tomo_avatar:v1:8:8:7:1:1:3', false),
    ('00000000-0000-4000-8000-000000000110'::uuid, 'dev-kai@tomo.app',    (select value from seed_password), 'Kai',    'dev_kai',    'avatar', 'tomo_avatar:v1:9:9:8:2:2:2', false)
)
...
with seed(id, email) as (
  values
    ('00000000-0000-4000-8000-000000000101'::uuid, 'dev-yuta@tomo.app'),
    ('00000000-0000-4000-8000-000000000102'::uuid, 'dev-ken@tomo.app'),
    ('00000000-0000-4000-8000-000000000103'::uuid, 'dev-ryo@tomo.app'),
    ('00000000-0000-4000-8000-000000000104'::uuid, 'dev-haru@tomo.app'),
    ('00000000-0000-4000-8000-000000000105'::uuid, 'dev-takumi@tomo.app'),
    ('00000000-0000-4000-8000-000000000106'::uuid, 'dev-mika@tomo.app'),
    ('00000000-0000-4000-8000-000000000107'::uuid, 'dev-ren@tomo.app'),
    ('00000000-0000-4000-8000-000000000108'::uuid, 'dev-saki@tomo.app'),
    ('00000000-0000-4000-8000-000000000109'::uuid, 'dev-ana@tomo.app'),
    ('00000000-0000-4000-8000-000000000110'::uuid, 'dev-kai@tomo.app')
)
...
values
  ('00000000-0000-4000-8000-000000000101', 'ユウタ', 'dev_yuta',   'male', 'avatar', 'tomo_avatar:v1:0:1:2:0:0:3', true),
  ('00000000-0000-4000-8000-000000000102', 'ケン',   'dev_ken',    'male', 'avatar', 'tomo_avatar:v1:5:2:5:2:1:0', false),
  ('00000000-0000-4000-8000-000000000103', 'リョウ', 'dev_ryo',    'male', 'avatar', 'tomo_avatar:v1:2:6:0:3:0:1', false),
  ('00000000-0000-4000-8000-000000000104', 'ハル',   'dev_haru',   'female', 'avatar', 'tomo_avatar:v1:1:4:3:1:2:3', false),
  ('00000000-0000-4000-8000-000000000105', 'タクミ', 'dev_takumi', 'male', 'avatar', 'tomo_avatar:v1:3:5:6:0:1:0', false),
  ('00000000-0000-4000-8000-000000000106', 'ミカ',   'dev_mika',   'female', 'avatar', 'tomo_avatar:v1:4:3:1:4:2:2', false),
  ('00000000-0000-4000-8000-000000000107', 'レン',   'dev_ren',    'male', 'avatar', 'tomo_avatar:v1:6:0:4:5:3:1', false),
  ('00000000-0000-4000-8000-000000000108', 'サキ',   'dev_saki',   'female', 'avatar', 'tomo_avatar:v1:7:7:3:6:4:0', false),
  ('00000000-0000-4000-8000-000000000109', 'Ana',    'dev_ana',    'female', 'avatar', 'tomo_avatar:v1:8:8:7:1:1:3', false),
  ('00000000-0000-4000-8000-000000000110', 'Kai',    'dev_kai',    'male', 'avatar', 'tomo_avatar:v1:9:9:8:2:2:2', false)
on conflict (id) do update set
