...
- `seed_dev_rich_data.sql`: creates a broader dev dataset with 10 confirmed users, varied friendship/request states, all daily status patterns, current/previous-month drink logs, drink-log friends, likes, and one report sample.
