...
final class OheyArchiveMapFactory: NSObject, FlutterPlatformViewFactory {
  ...
  func create(
    ...
    OheyArchiveMapView(frame: frame, viewIdentifier: viewId, arguments: args, messenger: messenger)
  }
}

private final class OheyArchiveAnnotation: MKPointAnnotation {
...
final class OheyArchiveMapView: NSObject, FlutterPlatformView, MKMapViewDelegate {
  ...
  init(
    ...
    channel = FlutterMethodChannel(name: "ohey/archive_map_\(viewId)", binaryMessenger: messenger)
    super.init()
  ...
  private func configureAnnotations(_ args: Any?) {
    ...
    let coordinatePins = annotations.compactMap { item -> OheyArchiveAnnotation? in
  ...
  ) -> OheyArchiveAnnotation {
    let fallbackId = item["title"] as? String ?? UUID().uuidString
    let annotation = OheyArchiveAnnotation(identifier: item["id"] as? String ?? fallbackId)
  ...
  private func geocode(
    items: [[String: Any]],
    completion: @escaping ([OheyArchiveAnnotation]) -> Void
  ) {
    var results: [OheyArchiveAnnotation] = []
  ...
  func mapView(_ mapView: MKMapView, didSelect annotation: MKAnnotation) {
    guard let annotation = annotation as? OheyArchiveAnnotation else { return }
    channel.invokeMethod("annotationSelected", arguments: ["id": annotation.identifier])
    mapView.deselectAnnotation(annotation, animated: true)
  }

  func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
    guard annotation is OheyArchiveAnnotation else { return nil }
    let identifier = "OheyArchiveAnnotation"
