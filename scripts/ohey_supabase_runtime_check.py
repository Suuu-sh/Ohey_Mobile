#!/usr/bin/env python3
"""Runtime Supabase REST/RLS/GRANT checks for Ohey.
...
Optional env:
  ...
  OHEY_SMOKE_EMAIL / OHEY_SMOKE_PASSWORD
...
def main() -> int:
    ...
    email = env("OHEY_SMOKE_EMAIL", required=False) or env("OHEY_TEST_EMAIL", required=False)
    password = env("OHEY_SMOKE_PASSWORD", required=False) or env("OHEY_TEST_PASSWORD", required=False)
    ...
    if email and password:
        ...
        print("SKIP auth.sign_in: OHEY_SMOKE_EMAIL/PASSWORD not set")
