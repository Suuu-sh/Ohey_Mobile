#!/usr/bin/env python3
"""Runtime Supabase REST/RLS/GRANT checks for Nomo.
...
Optional env:
  ...
  NOMO_SMOKE_EMAIL / NOMO_SMOKE_PASSWORD
...
def main() -> int:
    ...
    email = env("NOMO_SMOKE_EMAIL", required=False) or env("NOMO_TEST_EMAIL", required=False)
    password = env("NOMO_SMOKE_PASSWORD", required=False) or env("NOMO_TEST_PASSWORD", required=False)
    ...
    if email and password:
        ...
        print("SKIP auth.sign_in: NOMO_SMOKE_EMAIL/PASSWORD not set")
