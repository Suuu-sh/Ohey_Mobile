    ...
    return Column(
      ...
      children: [
        ...
        TomoThemedPanel(
          ...
          borderRadius: 0,
          border: TomoThemedPanelBorder.horizontal,
          borderWidth: 1,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [
                  _AddMemoryColors.lime.withValues(alpha: .34),
                  _AddMemoryColors.lime.withValues(alpha: .09),
                ],
              ),
            ),
            child: TomoAvatarView(avatar: avatar, size: 38.5),
          ),
                  ...
                  child: Stack(
                    ...
                    children: [
                      TextField(
                        ...
                        cursorColor: _AddMemoryColors.lime,
          ...
          Row(
            ...
            children: [
              ...
              TomoPostActionPill(
                ...
                customIcon: TomoPostShareIcon(
                  color: tomoPostActionForeground(_postPreviewActionPurple),
                  size: 19,
                ),
                label: 'また誘う',
                color: _postPreviewActionPurple,
              ...
              if (friends.isNotEmpty) ...[
                const SizedBox(width: 8),
                TomoPostCompanionPill(
                  avatars: friends
                      .map(
                        (friend) => friend.avatar ?? TomoAvatar.defaultAvatar,
                      )
...
class _PhotoPreviewImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<TomoPhotoDimensions>(
      future: tomoReadPhotoDimensions(path),
...
double _safePhotoAspectRatio(TomoPhotoDimensions dimensions) {
...
class _MiniActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: _AddMemoryColors.lime.withValues(alpha: .16),
        borderRadius: BorderRadius.circular(999),
        border: Border.all(color: _AddMemoryColors.lime.withValues(alpha: .28)),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          TomoGeneratedIcon(icon, color: _AddMemoryColors.lime, size: 15),
