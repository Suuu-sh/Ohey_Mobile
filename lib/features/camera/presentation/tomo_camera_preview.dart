...
class _ArAvatarCameraViewState extends State<_ArAvatarCameraView> {
  ...
  Widget build(BuildContext context) {
    return UiKitView(
      viewType: 'tomo/ar_avatar_camera',
      creationParams: {
...
class _ArAvatarCameraController {
  _ArAvatarCameraController(int viewId)
    : _channel = MethodChannel('tomo/ar_avatar_camera_$viewId');
  ...
  Future<void> setAvatar(TomoAvatar avatar) {
...
Map<String, Object?> _avatarPayload(TomoAvatar avatar) => {
  'skin': avatar.skin,
  'hair': avatar.hair,
  'shirt': avatar.shirt,
  'eyes': avatar.eyes,
