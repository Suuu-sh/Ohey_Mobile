...
class _FriendsList extends StatelessWidget {
  ...
  final void Function(TomoFriend friend, bool isFavorite) onFavoriteToggle;
  final VoidCallback onAddFriend;
  final Future<void> Function(TomoFriend friend) onInvite;
  final Future<void> Function(List<TomoFriend> friends) onGroupInvite;
  final void Function(TomoFriend friend) onInviteAnimationComplete;
  final void Function(TomoFriend friend, _FriendStatus status) onProfile;
...
class _GroupScheduleSection extends StatelessWidget {
  ...
  final List<_DecoratedFriend> friends;
  final List<TomoFriend> inviteTargets;
...
class _GroupScheduleSuggestionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TomoThemedPanel(
      ...
      backgroundColor: TomoThemedPanel.surfaceColor(isWhite: isWhite),
    ...
    return TomoThemedPanel(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            width: double.infinity,
            child: TomoInviteSuccessBurst(
              builder: (context, runWithBurst, flightAnimation) => Tomo3DButton(
                label: isInvited ? '招待済み' : '誘う',
                icon: null,
                customIcon: isInvited
                    ? null
                    : TomoInviteFlyingIcon(
...
int _daysSinceLastMemory(TomoFriend friend) {
...
int _compareFriendsForList(_DecoratedFriend a, _DecoratedFriend b) {
  ...
  final statusRankCompare = tomoDailyStatusFromKey(a.friend.statusKey)
      .availabilityRank
      .compareTo(tomoDailyStatusFromKey(b.friend.statusKey).availabilityRank);
...
TomoFriend _friendWithFavorite(TomoFriend friend, bool isFavorite) {
      ...
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            child: TomoAvatarView(avatar: avatar, size: 76),
          ),
          Positioned(
            right: 22,
            bottom: 18,
