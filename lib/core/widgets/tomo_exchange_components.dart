...
/// [TomoActionTile] for non-exchange settings/actions.
class TomoQrDisplayCard extends StatelessWidget {
  const TomoQrDisplayCard({
    super.key,
    required this.title,
        ...
        Row(
          children: [
            Container(
              ...
              child: TomoAvatarView(avatar: avatar, size: 58),
            ),
            ...
            TomoPopIcon(icon: CupertinoIcons.qrcode, color: accentColor),
          ],
        ),
...
/// Action card for the Tomo friend-exchange flow.
///
/// This is intentionally more branded than [TomoActionTile], which remains the
/// generic bottom-sheet/action-list tile.
class TomoExchangeActionCard extends StatelessWidget {
  const TomoExchangeActionCard({
    super.key,
    required this.icon,
    required this.title,
    required this.subtitle,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: childBuilder(
        ...
        Row(
          children: [
            TomoPopIcon(icon: icon, color: accent),
            const SizedBox(width: 12),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
...
class TomoProfileResultSheet extends StatelessWidget {
  const TomoProfileResultSheet({
    super.key,
    required this.avatar,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: TomoAvatarView(avatar: avatar, size: 96),
            ),
            ...
            Tomo3DButton(
              ...
              shadowColor: tomo3DShadowColorFor(
                accentColor,
                lightnessScale: .58,
              ),
              fontSize: 16,
