...
Future<T?> showTomoBottomSheet<T>({
...
class TomoBottomSheetShell extends StatelessWidget {
  const TomoBottomSheetShell({
    super.key,
    required this.child,
    this.title,
    this.onClose,
...
class TomoBottomSheetHandle extends StatelessWidget {
  const TomoBottomSheetHandle({super.key});
...
class TomoCloseButton extends StatelessWidget {
  const TomoCloseButton({
    super.key,
    required this.onTap,
    this.enabled = true,
    this.size = 40,
