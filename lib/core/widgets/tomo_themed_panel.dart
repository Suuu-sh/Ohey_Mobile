...
class TomoThemedPanel extends StatelessWidget {
  const TomoThemedPanel({
    ...
    this.borderWidth = 1,
    this.borderAlpha = .28,
    this.border = TomoThemedPanelBorder.all,
    this.glowAlpha = .16,
    this.glowBlur = 28,
  ...
  final TomoThemedPanelBorder border;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: switch (border) {
          TomoThemedPanelBorder.all => Border.all(
            color: side.color,
            width: side.width,
          ),
          TomoThemedPanelBorder.horizontal => Border.symmetric(
            horizontal: side,
          ),
        },
