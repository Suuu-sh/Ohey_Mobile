...
class Tomo3DButton extends StatelessWidget {
  const Tomo3DButton({
    super.key,
    required this.label,
    required this.onTap,
  ...
  const Tomo3DButton.destructive({
    super.key,
    required this.label,
    required this.onTap,
    this.icon,
...
class Tomo3DButtonSurface extends StatefulWidget {
  const Tomo3DButtonSurface({
    super.key,
    required this.child,
    required this.onTap,
    this.height = 58,
  ...
  @override
  State<Tomo3DButtonSurface> createState() => _Tomo3DButtonSurfaceState();
}

class _Tomo3DButtonSurfaceState extends State<Tomo3DButtonSurface> {
  ...
  Widget build(BuildContext context) {
    ...
    final base = isUnavailable && widget.disabledColor != null
        ...
        : widget.color;
    final bottom = widget.bottomColor ?? tomo3DShadowColorFor(base);
