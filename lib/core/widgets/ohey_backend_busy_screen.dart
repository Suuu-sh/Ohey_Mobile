...
class OheyBackendBusyScreen extends StatefulWidget {
  const OheyBackendBusyScreen({super.key});

  @override
  State<OheyBackendBusyScreen> createState() => _OheyBackendBusyScreenState();
}

class _OheyBackendBusyScreenState extends State<OheyBackendBusyScreen>
...
class _BusyMascotIllustration extends StatelessWidget {
  ...
  static const _assetPath = 'assets/images/backend_busy_ohey.png';
