...
class NomoPopIcon extends StatelessWidget {
  const NomoPopIcon({
    super.key,
    required this.icon,
    this.size = 34,
...
class NomoGeneratedIcon extends StatelessWidget {
  const NomoGeneratedIcon(this.icon, {super.key, this.color, this.size});
