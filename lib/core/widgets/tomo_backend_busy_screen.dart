...
class TomoBackendBusyScreen extends StatefulWidget {
  const TomoBackendBusyScreen({super.key});

  @override
  State<TomoBackendBusyScreen> createState() => _TomoBackendBusyScreenState();
}

class _TomoBackendBusyScreenState extends State<TomoBackendBusyScreen>
...
class _BusyMascotIllustration extends StatelessWidget {
  ...
  static const _assetPath = 'assets/images/backend_busy_tomo.png';
