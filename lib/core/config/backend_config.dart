...
/// Go backend environment configuration for Tomo.
///
...
/// dart-defines are missing, and may still override with `TOMO_BACKEND_URL`.
class BackendConfig {
  ...
  static const _definedBaseUrl = String.fromEnvironment('TOMO_BACKEND_URL');
